...
public class CollaborativeFiltering {
	 ...
	 * What this function returns is a map with the recommendations (these elements are returned sorted in decreasing order by their rating)
	 ...
	 */
	public static Map<String, Double> getSimilarMovies(String ratedMovie, double rating, double fixer, List<ArrayList<Double>> matrix, List<LinkedList<String>> movies) {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// Name of the movie
		String movie = "Jumanji (1995)";
		// Rating of the user
		double rating = 5.0;
		// We need the average of the possible rating values by the user (0.5,1.0,...,4.5,5.0)
		double meanOfRatingValues = 2.5; 
		
		Map<String, Double> similarMovies = getSimilarMovies(movie, rating, meanOfRatingValues, csMatrix, films);
		...
		*/
		...
		// Creating the scanner for the data of the user
		Scanner keyboard = new Scanner(System.in)) {
			...
			do {						
				...
				// Checks if the rating is correct (betwen 1.0 and 5.0 (0.5 increments)
		...
		for (String ratedMovie : userRatings.keySet()) {
			...
			Map<String, Double> rMovies = CollaborativeFiltering.getSimilarMovies(ratedMovie, userRatings.get(ratedMovie), 2.75, csMatrix, films);
