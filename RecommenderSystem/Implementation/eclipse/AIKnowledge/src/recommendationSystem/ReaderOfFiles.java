...
public abstract class ReaderOfFiles {
	...
	public static List<LinkedList<String>> getMovies(String fileName, String divider){
		...
		// This regular expression is used for the movies with "" in his name
		String regularExpressionLine = "(\".+,\")(\".+\")(\",.+\")";
		String regularExpresionId = "\"(.+),\"";
		String regularExpresionGenres = "\",(.+)\"";
			...
			if( line == null) {
		        ...
		        while ((line = reader.readLine()) != null) {
		        	...
		        	if(line.matches(regularExpressionLine)) {
		        		...
		        		// We add the id of the movie
		        		row.add(mat2.group(1));
		        		
		        		// We add the name of the movie
		        		row.add(mat.group(2));
		        		
		        		// We add the genres of the movie
		        		String genresWithoutSplit = mat3.group(1);
		        		
		        		genres = genresWithoutSplit.split(":");
		        		
		        		// We add the genres to the row
			    		for(String g : genres) {
			    			row.add(g);
			    		}
